...
# Post-Commentary Thoughts
\
\
1. Thank you to Lia for the comments! I agree, my function comments are a bit much in some regards.
\
\
2. I appreciated Alistair's function code; I understand how people from different coding backgrounds approach the same problems (the || and && are very non-R). I like test-casing a problem and troubleshooting other people's code, definitely a stimulating exercise.
